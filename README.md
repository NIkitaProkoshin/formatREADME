...
Три команды позволяющие перенести свой репозиторий на удаленный сервис.
...
1. git remote add origin
 ...
 с удаленного репозитория, а так же производит слияние веток с удаленного сервиса и репозитория на компьютер. 
